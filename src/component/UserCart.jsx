    ...
    >
      ...
      <div className='flex mt-4 gap-2'>
        ...
        <button
          ...
          className={`w-full py-2 rounded-md flex justify-center items-center gap-2 text-white cursor-pointer transition active:scale-95 ${
            isFollowing
              ? 'bg-gray-400'
        ...
        <button
          className='p-2 rounded-md flex justify-center items-center text-white cursor-pointer transition active:scale-95 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700'
        >
          {isConnected ? (
